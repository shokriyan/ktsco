...
public class DepositDAO {
	...
	public static ObservableList<DepositSearchModel> depositSearchList(String bank, String employee,
		...
		String accountID = (!"".equalsIgnoreCase(bank))? String.valueOf(AccountsDAO.getBankID(bank.split("-")[1].trim())): "";
		...
		try {
			...
			while (resultSet.next()) {
				...
				DepositSearchModel model = new DepositSearchModel(receiveID, bankName, emp, voucher, jDepositDate, depositAmount);
				list.add(model);
			}
