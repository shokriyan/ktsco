...
public class CentralStockReportController implements Initializable {
	...
	public void populateTableData(String code) {
		tableData.clear();
		List<Map<String, Object>> dbResult = MainStockDAO.getCenteralStockReport(code);
		dbResult.forEach(map -> {
			...
			ProductsRepoModel model = new ProductsRepoModel(id, item, unit, imported.doubleValue(),
